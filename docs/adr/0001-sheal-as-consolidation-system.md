...
diverged). Results are frozen as evidence at `docs/adr/0001-validation/`
(topic pages, change set, review queue) — evidence of the decision, not
living data; recurring output belongs to sheal itself under `.sheal/`:
