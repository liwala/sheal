...
- [x] [T10. Gated sbx checkpoint-all](t10-gated-sbx-checkpoint-all.md) — `done` → src/commands/pull.ts, src/index.ts, src/config/types.ts, src/config/defaults.ts, test/pull-checkpoint.test.ts, README.md, docs/adr/0005-sheal-pull-acquisition-adapters.md
